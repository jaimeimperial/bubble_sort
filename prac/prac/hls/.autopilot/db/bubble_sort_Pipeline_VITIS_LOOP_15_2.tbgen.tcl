set moduleName bubble_sort_Pipeline_VITIS_LOOP_15_2
set isTopModule 0
...
set C_modelName {bubble_sort_Pipeline_VITIS_LOOP_15_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict M { MEM_WIDTH 32 MEM_SIZE 80 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ zext_ln10_1 int 5 regular  }
	{ A int 32 regular  }
	{ M int 32 regular {array 20 { 2 0 } 1 1 }  }
	{ zext_ln10 int 5 regular  }
}
set hasAXIMCache 0
set hasAXIML2Cache 0
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln10_1", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "A", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "M", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "zext_ln10", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ zext_ln10_1 sc_in sc_lv 5 signal 0 } 
	...
	{ M_address1 sc_out sc_lv 5 signal 2 } 
	{ M_ce1 sc_out sc_logic 1 signal 2 } 
	{ M_we1 sc_out sc_logic 1 signal 2 } 
	{ M_d1 sc_out sc_lv 32 signal 2 } 
	{ zext_ln10 sc_in sc_lv 5 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln10_1", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "zext_ln10_1", "role": "default" }} , 
 	...
 	{ "name": "zext_ln10", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "zext_ln10", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4", "Max" : "40"}
	, {"Name" : "Interval", "Min" : "4", "Max" : "40"}
]}
...
set Spec2ImplPortList { 
	zext_ln10_1 { ap_none {  { zext_ln10_1 in_data 0 5 } } }
	...
	zext_ln10 { ap_none {  { zext_ln10 in_data 0 5 } } }
}
