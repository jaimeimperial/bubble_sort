set moduleName bubble_sort_Pipeline_VITIS_LOOP_61_1
set isTopModule 0
...
set C_modelName {bubble_sort_Pipeline_VITIS_LOOP_61_1}
...
set C_modelArgList {
	{ M int 32 regular {array 20 { 1 1 } 1 1 }  }
}
set hasAXIMCache 0
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3", "Max" : "41"}
	, {"Name" : "Interval", "Min" : "3", "Max" : "41"}
]}
...
set Spec2ImplPortList { 
	M { ap_memory {  { M_address0 mem_address 1 5 }  { M_ce0 mem_ce 1 1 }  { M_q0 mem_dout 0 32 }  { M_address1 MemPortADDR2 1 5 }  { M_ce1 MemPortCE2 1 1 }  { M_q1 MemPortDOUT2 0 32 } } }
}
