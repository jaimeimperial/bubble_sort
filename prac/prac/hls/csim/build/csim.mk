...
HLS_SOURCES = ../../../../bubble_sort_tb.cpp ../../../../bubble_sort.cpp
...
$(ObjDir)/bubble_sort_tb.o: ../../../../bubble_sort_tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../bubble_sort_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/bubble_sort_tb.d
