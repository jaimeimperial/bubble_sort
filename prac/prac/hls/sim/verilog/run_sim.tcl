...
if {[file isfile bubble_sort.autotvin.dat]} {
	file delete -force bubble_sort.autotvin.dat
}

if {[file isfile bubble_sort.autotvout.dat]} {
	file delete -force bubble_sort.autotvout.dat
}
