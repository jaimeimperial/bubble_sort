...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "bubble_sort.autotvin.dat"
	set constFileTvOut       "bubble_sort.autotvout.dat"
	set constFileHdlTvIn     "bubble_sort.autohdltvin.dat"
	set constFileHdlTvOut    "bubble_sort.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
