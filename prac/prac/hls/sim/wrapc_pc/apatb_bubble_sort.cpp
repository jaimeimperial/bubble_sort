...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_M),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_M),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_M),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_M),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_M),
#else
